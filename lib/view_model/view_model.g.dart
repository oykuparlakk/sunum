...
mixin _$ViewModel on _ViewModelBase, Store {
  ...
  bool get isEven => (_$isEvenComputed ??=
          Computed<bool>(() => super.isEven, name: '_ViewModelBase.isEven'))
      .value;

  late final _$numberAtom =
      Atom(name: '_ViewModelBase.number', context: context);
  ...
  late final _$_ViewModelBaseActionController =
      ActionController(name: '_ViewModelBase', context: context);

  @override
  void Increment() {
    final _$actionInfo = _$_ViewModelBaseActionController.startAction(
        name: '_ViewModelBase.Increment');
    try {
